...
- 2026-04-30 public CTA/card repair pass: made home Explore Specs cards route to their matching service/product pages with visible button pills, made glass/service Technical Spec buttons always visible and anchored to the technical sections, improved TechShowcase selector contrast/readability, and constrained the quote page image caption card so its title/body stay inside the panel.
