          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {systems.map((s, i) => (
              <Reveal key={s.name} delay={i * 0.08}>
                <article className="group h-full flex flex-col bg-white border border-osg-navy/5 hover:border-osg-gold transition-all duration-500 shadow-sm hover:shadow-[0_20px_60px_-15px_rgba(10,22,40,0.18)] overflow-hidden">
                  <div className="relative aspect-[4/3] overflow-hidden bg-osg-navy">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-osg-navy/60 via-transparent to-transparent" />
                    <span className="absolute top-5 right-5 bg-osg-gold text-osg-navy px-3 py-1.5 text-[10px] font-black uppercase tracking-widest">
                      {s.tag}
                    </span>
                  </div>
                  <div className="flex flex-col flex-grow p-7">
                    <h3 className="text-xl font-serif font-black text-osg-navy uppercase mb-3 leading-tight">
                      {s.name}
                    </h3>
